 ...
 * file, the entry's data is augmented with `lastCommitSha`, `lastCommitDate`,
 * and `lastCommitUrl` resolved from git before the collection schema is
 * applied. Non-existent or untracked files leave these fields `null`.
 *
