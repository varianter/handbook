...
I Variant liker vi åpnenhet. Det betyr at du selvsagt ikke trenger å lure på hvordan kontrakten din vil se ut for sommeren, den ligger nemlig åpent og tilgjengelig [her](https://avtaler.variant.no/avtaler/ansettelse-sommerjobb.html).
