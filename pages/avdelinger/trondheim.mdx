...
<IllustrationHeading headingText="Faktura" figureName="coins" />

Hvis du får en faktura som skal betales av Variant Trondheim sendes den til
**faktura.trondheim@variant.no**.

<IllustrationHeading
  headingText="Kontoer for innkjøp"
  figureName="creditCard"
/>
...
<IllustrationHeading headingText="Sossisfond" figureName="confetti" />
...
<IllustrationHeading headingText="Personalledere" figureName="person" />
...
<IllustrationHeading headingText="Fagkomité" figureName="group" />

- Maciek (leder)
- Truls Henrik

<IllustrationHeading headingText="Fagledelse" figureName="graduationCap" />

- Hilde på design
- Anders på utvikling

<IllustrationHeading headingText="Soskom" figureName="group" />
...
<IllustrationHeading headingText="Onboardingsansvarlig" figureName="group" />
