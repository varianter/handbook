...
- CDO: 1 600 000 kr
- CRO: 1 100 000 kr
- CEO Trondheim: 1 500 000 kr
- CEO Oslo: 1 300 000 kr
- CEO Bergen: 1 100 000 kr

##### Overgangstid ledertillegg
Vi har til nå operert med tillegg til lønn for ledere i ulike selskaper. Disse ligger i dag på 200 000 kr for hver leder (CTO og CDO i selskaper). Målet er å gå over til lønn ut i fra prinsippene beskrevet i forrige avsnitt.

#### Andre som jobber for Variant
Etter hvert som Variant har vokst, får vi behov for administrative og driftskritiske ressurser som gir uvurderlige bidrag til organisasjonen. Støtteroller som økonomi, drift og renhold skal også sikres gode betingelser. I dag har vi ansatt unge reholdere som både får arbeidserfaring og mulighet til å ha en egen økonomi. Her følger vi  arbeidstilynets anbefalinger for minstelønn for renhold. 
